// If a filepicker_apikey is givne in the global config, load + init filepicker.io api
if (window.wobble_config.filepicker_apikey) {
  // Init block from https://developers.filepicker.io/docs/web/
  (function(a) {
  ...
  // Initialize it
  filepicker.setKey(window.wobble_config.filepicker_apikey);
}
